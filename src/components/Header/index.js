...
function Header() {
  return (
    <header className='bg-brand-color sticky top-0 left-0 z-50'>
      <div className='container mx-auto h-11 flex items-center justify-between'>
        ...
        <nav className='flex gap-x-8 text-sm font-semibold'>
          <a
            ...
            className='flex items-center text-white transition-all text-opacity-70 hover:text-opacity-100  gap-x-2'
          >
            <TbWorld size={20} />
            Türkçe (TR)
          </a>
